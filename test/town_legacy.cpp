...
TEST_CASE("Converting legacy town data") {
	...
	SECTION("With preset fields") {
		...
		CHECK(town.preset_fields[0].type == fields::FIELD_WEB);
		CHECK(town.preset_fields[1].loc == loc(4,4));
		CHECK(town.preset_fields[1].type == fields::OBJECT_CRATE);
		CHECK(town.preset_fields[2].loc == loc(5,5));
		CHECK(town.preset_fields[2].type == fields::OBJECT_BARREL);
		CHECK(town.preset_fields[3].loc == loc(6,6));
		CHECK(town.preset_fields[3].type == fields::BARRIER_FIRE);
		CHECK(town.preset_fields[4].loc == loc(7,7));
		CHECK(town.preset_fields[4].type == fields::BARRIER_FORCE);
		CHECK(town.preset_fields[5].loc == loc(8,8));
		CHECK(town.preset_fields[5].type == fields::FIELD_QUICKFIRE);
		CHECK(town.preset_fields[6].loc == loc(14,14));
		CHECK(town.preset_fields[6].type == fields::SFX_SMALL_BLOOD);
		CHECK(town.preset_fields[7].loc == loc(15,15));
		CHECK(town.preset_fields[7].type == fields::SFX_MEDIUM_BLOOD);
		CHECK(town.preset_fields[8].loc == loc(16,16));
		CHECK(town.preset_fields[8].type == fields::SFX_LARGE_BLOOD);
		CHECK(town.preset_fields[9].loc == loc(17,17));
		CHECK(town.preset_fields[9].type == fields::SFX_SMALL_SLIME);
		CHECK(town.preset_fields[10].loc == loc(18,18));
		CHECK(town.preset_fields[10].type == fields::SFX_LARGE_SLIME);
		CHECK(town.preset_fields[11].loc == loc(19,19));
		CHECK(town.preset_fields[11].type == fields::SFX_ASH);
		CHECK(town.preset_fields[12].loc == loc(20,20));
		CHECK(town.preset_fields[12].type == fields::SFX_BONES);
		CHECK(town.preset_fields[13].loc == loc(21,21));
		CHECK(town.preset_fields[13].type == fields::SFX_RUBBLE);
	}
